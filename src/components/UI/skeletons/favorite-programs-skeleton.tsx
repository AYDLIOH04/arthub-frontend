const FavoriteProgramsSkeleton = () => {
  const brushCount = 4;

  const brushElements = [];
  for (let i = 0; i < brushCount; i++) {
    brushElements.push(<ProgramSkeleton key={i} />);
  }
...
export default FavoriteProgramsSkeleton;


const ProgramSkeleton = () => {
  return (
    <div className="flex flex-col border-2 border-second_purple rounded-md overflow-hidden w-[288px] max-h-[670px]">
